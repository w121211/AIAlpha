...
base = BaseBars("sample_data/raw_data/price_vol.csv",
                "sample_data/processed_data/price_bars/tick_bars.csv", "tick", 10)
base.batch_run()

print('Creating dollar bars...')
base = BaseBars("sample_data/raw_data/price_vol.csv",
                "sample_data/processed_data/price_bars/dollar_bars.csv", "dollar", 20000)
base.batch_run()

print('Creating volume bars...')
base = BaseBars("sample_data/raw_data/price_vol.csv",
                "sample_data/processed_data/price_bars/volume_bars.csv", "volume", 50)
base.batch_run()
...
autoencoder.train_model(autoencoder.autoencoder, x_train_a,
                        epochs=20, model_name='autoencoder')
...
autoencoder.encode_data(
    a_scaled_full, csv_path='sample_data/processed_data/nn_data/full_x.csv')

print('Processing data...')
preprocess = DataProcessing(0.8)
df1 = pd.read_csv("sample_data/processed_data/nn_data/full_x.csv", index_col=0)
df2 = pd.read_csv(
    'sample_data/processed_data/autoencoder_data/full_y.csv', index_col=0)
...
print('Loading data...')
train_x = pd.read_csv(
    'sample_data/processed_data/rf_data/train_x.csv', index_col=0)
train_y = pd.read_csv(
    'sample_data/processed_data/rf_data/train_y.csv', index_col=0)
test_x = pd.read_csv(
    'sample_data/processed_data/rf_data/test_x.csv', index_col=0)
test_y = pd.read_csv(
    'sample_data/processed_data/rf_data/test_y.csv', index_col=0)
print(train_x.head())
print(train_y.shape)
